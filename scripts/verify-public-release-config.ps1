...
$expectations = [ordered]@{
    ...
    'version code 7' = $appGradle -match 'versionCode\s+7(?:\s|$)'
    'version name 1.0.6' = $appGradle -match 'versionName\s+"1\.0\.6"'
...
Write-Output 'GPS Driver release configuration verified: com.trickee.gpsdriverapp, 1.0.6 (7), target SDK 36.'
