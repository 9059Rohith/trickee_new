...
$expectations = [ordered]@{
    ...
    'version code 12' = $appGradle -match 'versionCode\s+12(?:\s|$)'
    'version name 1.0.11' = $appGradle -match 'versionName\s+"1\.0\.11"'
...
Write-Output 'GPS Driver release configuration verified: com.trickee.gpsdriverapp, 1.0.11 (12), target SDK 36.'
