...
$expectations = [ordered]@{
    ...
    'version code 11' = $appGradle -match 'versionCode\s+11(?:\s|$)'
    'version name 1.0.10' = $appGradle -match 'versionName\s+"1\.0\.10"'
...
Write-Output 'GPS Driver release configuration verified: com.trickee.gpsdriverapp, 1.0.10 (11), target SDK 36.'
