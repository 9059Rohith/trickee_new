...
$expectations = [ordered]@{
    ...
    'version code 6' = $appGradle -match 'versionCode\s+6(?:\s|$)'
    'version name 1.0.5' = $appGradle -match 'versionName\s+"1\.0\.5"'
...
Write-Output 'GPS Driver release configuration verified: com.trickee.gpsdriverapp, 1.0.5 (6), target SDK 36.'
